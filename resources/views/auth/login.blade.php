...
<html lang="en">
    <head>
        ...
        <link rel="stylesheet" href="{{asset('church')}}/css/animate/animate.min.css">
    ...
    <body class="bg-white">
        ...
        <div class="container-fluid no-padding h-100">
            <div class="row flex-row h-100 bg-white">
                ...
                <div class="col-xl-8 col-lg-6 col-md-5 no-padding">
                    <div style="background:url('{{asset('church/img/background/01.jpg')}}');background-size: cover; " class="elisyam-bg background-01">
                        ...
                        <div class="authentication-col-content mx-auto">
                            ...
                            <span class="description">
                               Empowering Twenty-First Century Ministries.
                            </span>
                        </div>
                    </div>
                </div>
        ...
        <!-- End Page Vendor Js -->
        <!-- Begin Page Snippets -->
        <script src="{{asset('church')}}/js/components/tabs/animated-tabs.min.js"></script>
        <!-- End Page Snippets -->
    </body>
</html>