    ...
    <div class="row">
        <div class="page-header">
            <div class="d-flex align-items-center">
                <h2 class="page-header-title">View Profile</h2>
                <div>
        ...
        <div class="col-xl-3">
            ...
            <div class="widget has-shadow">
                <div class="widget-body">
                    ...
                    <div class="mt-5">
                        <img src="{{ asset('uploads/images/associate_minister/'.$associateminister->file) }}" alt="..." style="width: 120px;" class="avatar rounded-circle d-block mx-auto">
                    </div>
                    <h4 class="text-center mt-3 mb-1">{{$associateminister->full_name}}</h4>
                    <div class="em-separator separator-dashed"></div>
                    <ul class="nav flex-column">
                        <li class="nav-item">
                            <p class="nav-link">
                                <i class="la la-phone la-2x align-middle pr-2"></i>
                                <a href="javascript:void(0)">{{$associateminister->phone}}</a>
                            </p>
                        </li>
                        ...
                        <li class="nav-item">
                            <p class="nav-link">
                                ...
                                <a href="javascript:void(0)">{{$associateminister->mobile}}</a>
                            </p>
                        </li>
                        <li class="nav-item">
                            <p class="nav-link">
                                <i class="la la-globe la-2x align-middle pr-2"></i>
                                <a href="{{$associateminister->web}}" target="_blank" >{{$associateminister->web}}</a>
                            </p>
                        </li>
                        ...
                        <li class="nav-item">
                            <p class="nav-link">
                                ...
                                <a href="javascript:void(0)" >{{$associateminister->email}}</a>
                            </p>
                        </li>
                    ...
                    <div class="tab-content pt-3">
                             ...
                             <div class="d-flex align-items-center">
                                ...
                                <div>
                                    <div class="page-header-tools">
                                        <a class="btn btn-gradient-01" href="{{route('admin.associate-ministers.edit',$associateminister->id)}}">Edit Profile</a>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="form-group row">
                            <div class="col-xl-6">
                                ...
                                <p> {{$associateminister->first_name}}</p>
                            </div>
                            <div class="col-xl-6">
                                <label class="form-control-label">Last Name</label>
                                <p>{{$associateminister->last_name}}</p>
                            </div>
                        </div>
                        <div class="form-group row">
                            <div class="col-xl-6">
                                <label class="form-control-label">Phone</label>
                                <p>{{$associateminister->phone}}</p>
                            </div>
                            <div class="col-xl-6">
                                <label class="form-control-label">Email</label>
                                <p>{{$associateminister->email}}</p>
                            </div>
                        </div>
                        <div class="form-group row">
                            <div class="col-xl-6">
                                <label class="form-control-label">Web Address</label>
                                <p> {{$associateminister->web}}</p>
                            </div>
