                        ...
                        <div class="widget-options">
                            <div class="dropdown">
                                ...
                                <div class="dropdown-menu">
                                    <a href="{{ url('/admin/peoples/add') }}" class="dropdown-item">
                                        Add People
                                    </a>
                                    <a href="{{ url('/admin/peoples') }}" class="dropdown-item">
                                        View People
                                    </a>
                                </div>
                            </div>
                                    ...
                                    <div class="tab-content">
                                        ...
                                        <div class="tab-pane" id="tab3">
                                            ...
                                            <ul class="pager wizard text-right">
                                                ...
                                                <li class="next d-inline-block">
                                                    <input type="submit" value="Update" class="finish btn btn-gradient-04">
                                                </li>
                                            </ul>
                                        </div><!-- /#tab3 -->
                                    </div>
