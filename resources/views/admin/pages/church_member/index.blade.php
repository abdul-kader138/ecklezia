                        ...
                        <table id="sorting-table" class="table table-hover mb-0">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td>FR</td>
                                    <td class="td-actions">
                                        <a href="{{ url('/admin/church_member/view') }}"><i class="la la-eye view"></i></a>
                                        <a href="{{ url('/admin/church_member/edit') }}"><i class="la la-edit edit"></i></a>
                                        <a href="{{ url('/admin/church_member/delete') }}"><i class="la la-trash-o delete"></i></a>
                                    </td>
                                </tr>
