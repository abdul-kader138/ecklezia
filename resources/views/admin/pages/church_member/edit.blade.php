        ...
        <div class="row">
            <div class="page-header">
                <div class="d-flex align-items-center">
                    <h2 class="page-header-title">Church Member</h2>
                    <div>
                        <ul class="breadcrumb">
                            <li class="breadcrumb-item"><a href="{{url('/admin/home')}}"><i class="ti ti-home"></i></a></li>
                            <li class="breadcrumb-item"><a href="#">App</a></li>
                            <li class="breadcrumb-item active">Church Member</li>
                        </ul>
                    </div>
                </div>
            </div>
                        ...
                        <div class="widget-options">
                            <div class="dropdown">
                                ...
                                <div class="dropdown-menu">
                                    <a href="{{ url('/admin/church_member/add') }}" class="dropdown-item">
                                        Add Member
                                    </a>
                                    <a href="{{ url('/admin/church_member') }}" class="dropdown-item">
                                        View Member
                                    </a>
                                </div>
                            </div>
                                        ...
                                        <div class="tab-pane" id="tab1">
                                            ...
                                            <div class="form-group row mb-3">
                                                <div class="col-xl-6 mb-3">
                                                    ...
                                                    <input type="text" value="Mr." class="form-control">
                                                </div>
                                                <div class="col-xl-6">
                                                    <label class="form-control-label">Last Name<span class="text-danger ml-2">*</span></label>
                                                    <input type="text" value="Deved" class="form-control">
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group row mb-5">
                                                ...
                                                <div class="col-xl-6">
                                                    ...
                                                    <div class="input-group">
                                                        ...
                                                        <input type="text" class="form-control" value="+005 0167004320">
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <div class="tab-pane" id="tab2">
                                            ...
                                            <div class="form-group row mb-3">
                                                <div class="col-xl-6 mb-3">
                                                    ...
                                                    <input type="text" value="user_name" class="form-control">
                                                </div>
                                                <div class="col-xl-6">
                                        ...
                                        <div class="tab-pane" id="tab3">
                                            ...
                                            <div class="form-group row mb-3">
                                                ...
                                                <div class="col-xl-6 mb-3">
                                                    ...
                                                    <input type="text" value="Baptized" class="form-control">
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group row mb-3">
                                                ...
                                                <div class="col-xl-6 mb-3">
                                                    ...
                                                    <input type="text" value="Membership Unique ID" class="form-control">
                                                </div>
                                            </div>
                                            ...
                                            <ul class="pager wizard text-right">
                                                ...
                                                <li class="next d-inline-block">
                                                    <input type="submit" value="Update" class="finish btn btn-gradient-01">
                                                </li>
                                            </ul>
                                        </div><!-- /#tab3 -->
                                    </div>
