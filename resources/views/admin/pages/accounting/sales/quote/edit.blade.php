...
<div class="row">
    <div class="col-xl-12">
        ...
        <div class="widget has-shadow">
            ...
            <form action="{{ url('/admin/accounting/quotes/update/'.$quote->id) }}" method="POST">
              @csrf
            ...
            <div class="widget-body">
                <div class="row filter">
                    <div class="form-group col-md-4">
                        ...
                        <input type="text" class="form-control" placeholder="Quote Number" name="quote_number" value="{{ $quote->quote_number }}" required>
                    </div>
                    <div class="form-group col-md-4">
                        <label>Customer/Company</label>
                        <input type="text" class="form-control" placeholder="Customer/Company" name="name" value="{{ $quote->name }}" required>
                    </div>
                    <div class="form-group col-md-4">
                        <label>Quote Date</label>
                    <input type="text" id="date" class="form-control" placeholder="Quote Date" name="quote_date" value="{{ $quote->quote_date }}" required>
                    </div>
                    <div class="form-group col-md-4">
                        <label>Due Date</label>
                        <input type="text" id="date2" class="form-control" placeholder="Due Date" name="due_date" value="{{ $quote->due_date }}" required>
                    </div>
                    <div class="form-group col-md-4">
                        <label>Prefix</label>
                        <input type="text" class="form-control" placeholder="Prefix" name="prefix" value="{{ $quote->prefix }}" required>
                    </div>
                </div>
                <hr>
                ...
                <div class="row">
                                        ...
                                        <tr>
                                          <td><div class="form-group">
                                              <select name="discount_type" class="form-control discount_type" onchange="change()">
                                                <option value="1" @if($quote->discount_type == '1') selected @endif> Flat</option>
                                                <option value="2" @if($quote->discount_type == '2') selected @endif> Percent</option>
                                              </select>
                                            </div>
                                          </td>
                                          <td align="right">
                                            <div class="form-group">
                                              <input style="text-align:right" type="text" name="discount_figure" id="discount_figure" class="form-control discount_figure" value="{{ $quote->discount_figure }}" data-valid-num="required">
                                            </div></td>
                      ...
                      <div class="row">
                        <div class="form-group col-lg-12">
                          ...
                          <textarea name="quote_note" rows="5" class="form-control"><?php echo $quote->quote_note ;?></textarea>
                        </div>
                      </div>
                      <div class="row">
