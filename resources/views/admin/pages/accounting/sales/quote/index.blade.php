    ...
    <div class="row">
        <div class="page-header">
            <div class="d-flex align-items-center">
                <h2 class="page-header-title">Quotes</h2>
                <div>
                                        <ul class="breadcrumb">
                        <li>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="td-actions">
                                    ...
                                    <a href="{{ url('/admin/accounting/quotes/edit/'.$quote->id) }}"><i class="la la-edit edit"></i></a>
                                    <a href="{{ url('/admin/accounting/quotes/delete/'.$quote->id) }}"><i class="la la-trash-o delete"></i></a>
