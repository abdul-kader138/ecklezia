    ...
    <div class="row">
        <div class="page-header">
            <div class="d-flex align-items-center">
                <h2 class="page-header-title">Direct Invoice</h2>
                <div>
                    <ul class="breadcrumb">
                        <li>
...
<div class="row">
    <div class="col-xl-12">
        ...
        <div class="widget has-shadow">
            ...
            <form action="{{ url('/admin/accounting/direct_invoice/update/'.$invoice->id) }}" method="POST">
              @csrf
     ...
     <div class="form-group">
                                 <select class="form-control" onchange="selectTax();" name="tax_type[]" id="tax_type[]" required>
                                    ...
                                    <option value="1"  @if($item->tax_type == '1') selected @endif disabled>Flat</option>
                    ...
                    <div class="col-md-2">
                        ...
                        <div class="form-group">
                                <input type="text" class="form-control" id="tax_result[]"  name="tax_rate[]" value="{{ $item->tax_rate }}" disabled="">
