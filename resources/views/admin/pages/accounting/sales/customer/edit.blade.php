    ...
    <div class="row">
        <div class="page-header">
            <div class="d-flex align-items-center">
                <h2 class="page-header-title">Edit Customer Invoice</h2>
                <div>
                    <ul class="breadcrumb">
                        <li>
    ...
    <div class="col-xl-12">
        ...
        <div class="widget has-shadow">
            ...
            <div class="widget-header bordered d-flex align-items-center flex-space-between">
                <div class="widget-title">
                    <h4>Edit Customer Invoice</h4>
                </div>

            </div>
            <form action="{{ url('/admin/accounting/customer_invoice/update/'.$invoice->id) }}" method="POST">
              @csrf
                       <div class="widget-body">
                <div class="row filter">
                    <div class="form-group col-md-4">
                        <label>Invoice Number</label>
                        <input type="text" class="form-control" placeholder="Invoice Number" name="invoice_number" value="{{ $invoice->invoice_number }}" required>
                    </div>
                    <div class="form-group col-md-4">
                        <label>Customer Name</label>
                        <input type="text" class="form-control" placeholder="Customer Name" name="customer_name" value="{{ $invoice->customer_name }}" required>
                    </div>
                    <div class="form-group col-md-4">
                        <label>Customer Email</label>
                        <input type="email" class="form-control" placeholder="Customer Email" name="customer_email" value="{{ $invoice->customer_email }}" required>
                    </div>

                    <div class="form-group col-md-4">
                        <label>Invoice Date</label>
                        <input type="text" id="start_date" class="form-control" placeholder="Invoice Date" name="invoice_date" value="{{ $invoice->invoice_date }}" required>
                    </div>
                    <div class="form-group col-md-4">
                        <label>Due Date</label>
                        <input type="text" id="end_date" class="form-control " placeholder="Due Date" name="due_date" value="{{ $invoice->due_date }}" required>
                    </div>
                    <div class="form-group col-md-4">
                        <label>Prefix</label>
                        <input type="text" class="form-control" placeholder="Prefix" name="prefix" value="{{ $invoice->prefix }}" required>
                    </div>
                </div>
                <hr>
                ...
                <div class="row" id="item{{ $item->id }}">
                     <div class="col-md-3">
                        ...
                        <div class="form-group">
                          <input type="text" class="form-control" value="{{ $item->item }}" name="item[]" required>
                                </div>
                     </div>
                    <div class="col-md-2">
     ...
     <div class="form-group">
                                 <select class="form-control" onchange="selectTax();" name="tax_type[]" id="tax_type[]" required>
                                    ...
                                    <option value="1"  @if($item->tax_type == '1') selected @endif>Flat</option>
                                    <option value="2" @if($item->tax_type == '2') selected @endif>Percentage</option>
                                </select>
                                </div>
                    </div>
                    <div class="col-md-2">
                        ...
                        <div class="form-group">
                                <input type="text" class="form-control" id="tax_result[]"  name="tax_rate[]" value="{{ $item->tax_rate }}" >
                    ...
                    <div class="col-md-1">
                        <label>Qty/Hrs</label>
<div class="form-group">
                            <input type="text" class="form-control"  name="qty[]" value="{{ $item->qty }}" required>
                        </div>
                    </div>
                    <div class="col-md-2">
                    ...
                    <div class="col-md-2">
                     ...
                     <div class="form-group">
                    <input type="text" class="form-control" disabled name="sub_total[]" value="{{ $item->sub_total }}" id="sub_total[]">
                </div>
              </div>             

                <div class="col-md-12">
                     <div class="form-group">                    
                      <input value="Delete Item" class="btn btn-danger" onclick="del({{ $item->id }})" type="button">
                ...
                <div class="row">
                                      ...
                                      <tbody>
                                        ...
                                        <tr>
                                          <td><div class="form-group">
                                              <select name="discount_type" class="form-control discount_type" onchange="change()">
                                                <option value="1" @if($invoice->discount_type == '1') selected @endif> Flat</option>
                                                <option value="2" @if($invoice->discount_type == '2') selected @endif> Percent</option>
                                              </select>
                                            </div>
                                          </td>
                                          <td align="right">
                                            <div class="form-group">
                                              <input style="text-align:right" type="text" name="discount_figure" id="discount_figure" class="form-control discount_figure" value="{{ $invoice->discount_figure }}" data-valid-num="required">
                                            </div></td>
                      ...
                      <div class="row">
                        <div class="form-group col-lg-12">
                          ...
                          <textarea name="invoice_note" rows="5" class="form-control"><?php echo $invoice->invoice_note ;?></textarea>
                        </div>
                      </div>
                      <div class="row">
...
<!-- End Container -->
     ...
     <div class="form-group">
                    ...
                    <div class="col-md-2">
                        <label>Tax Rate</label>
                        <div class="form-group">
                                <input type="text" class="form-control" id="tax_result[]"  name="tax_rate[]" value="3.35" >
                            </div>
                    </div>
                    <div class="col-md-1">
                        <label>Qty/Hrs</label>
