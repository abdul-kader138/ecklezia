    ...
    <div class="row">
        <div class="page-header">
            <div class="d-flex align-items-center">
                <h2 class="page-header-title">Customer Invoice List</h2>
                <div>
                                        <ul class="breadcrumb">
                        <li>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="td-actions">
                                    ...
                                    <a href="{{ url('/admin/accounting/customer_invoice/edit/'.$invoice->id) }}"><i class="la la-edit edit"></i></a>
                                    <a href="{{ url('/admin/accounting/customer_invoice/delete/'.$invoice->id) }}"><i class="la la-trash-o delete"></i></a>
