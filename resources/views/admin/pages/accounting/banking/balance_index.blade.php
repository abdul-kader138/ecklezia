    ...
    <div class="row">
        <div class="page-header">
            <div class="d-flex align-items-center">
                <h2 class="page-header-title">List All Account Balances</h2>
                <div>
                    <ul class="breadcrumb">
                        <li>
                        ...
                        <li>
                            <a href="{{ url('/admin/accounting/banking') }}" class="btn btn-info btn-square mr-1 mb-2">Banking</a>
                        </li>
                    </ul>
                </div>
            </div>
            ...
            <div class="widget has-shadow">
                ...
                <div class="widget-header bordered d-flex align-items-center flex-space-between">
                    <div class="widget-title">
                        <h4>List All Account Balances</h4>
                    </div>
