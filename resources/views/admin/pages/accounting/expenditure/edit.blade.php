                        ...
                        <div class="widget-body">
                            ...
                            <div class="panel panel-primary">
                                <div class="panel-body" >
                                    <form action="{{ url('/admin/accounting/expenditure/update/'.$expenditur->id) }}" method="POST">
                                        @csrf
                                    <div class="col-md-12">
                                        <div class="row">
                                            <div class="col-md-6">
                                                <fieldset>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-md-12">
                                                            <input name="product" type="text" class="form-control" placeholder="Product" value="{{ $expenditur->product }}" required>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-md-12">
                                                            <input name="price" type="text" class="form-control" placeholder="Price" value="{{ $expenditur->price }}" required>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-md-12">
                                                       <input id="start_date" name="exp_date" value="{{ $expenditur->exp_date }}" type="text" class="form-control">
                                                        </div>
                                                    </div>
                                            ...
                                            <div class="col-md-6">
                                                <fieldset>
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-md-12">
                                                            <input name="category" type="text" class="form-control" placeholder="Expenditure Category" value="{{ $expenditur->category }}" required>
                                                        </div>
                                                    </div>
                                                                <div class="form-group">
                                                        <label class="col-md-5 control-label">Quantity</label>
                                                        <div class="col-md-12">
                                                            <input name="qty" type="text" class="form-control" placeholder="Quantity" value="{{ $expenditur->qty }}" required>
                                                        </div>
                                                    </div>
                                                    <!-- Name input-->
                                                ...
                                                <fieldset>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-md-12">
                                                            <textarea class="form-control" rows="4" id="basic-example" placeholder="Description" name="description"  > <?php echo $expenditur->description; ?></textarea>
                                                        </div>
                                                    </div>
