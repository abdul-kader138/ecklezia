...
@foreach($ministry->note as $note)
            ...
            <div class="widget-header d-flex align-items-center">
                ...
                <div class="d-flex flex-column mr-auto">
                    ...
                    <div class="time">{{$note->created_at->format('F d, Y')}}</div>
                </div>
                <div class="widget-options">
                    ...
                    <div class="dropdown">
                        ...
                        <div class="dropdown-menu">
                            ...
                            <a href="#" onclick="confirm('are You sure delete?')?$('#delete_form_{{$note->id}}').submit():null" class="dropdown-item">
