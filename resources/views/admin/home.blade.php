        ...
        <div class="row">
            <div class="page-header">
                <div class="d-flex align-items-center">
                    <h2 class="page-header-title">Dashboard <small>Home</small> </h2>
                    <div>
                ...
                <div class="widget widget-12 has-shadow">
                    <div class="widget-body">
                        <div class="media">
                            ...
                            <div class="media-body align-self-center">
                                <div class="title text-instagram">@David_Green</div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-xl-2 col-12 d-flex flex-column my-auto no-padding text-center">
                                <div class="new-orders">
                                    <div class="title">Church Attendance</div>
                        ...
                        <div class="post-container">
                            <div class="media mb-3">
                                <div class="media-left align-self-center user">
                                    <a href="#"><img src="{{ asset('church/img/avatar/avatar-07.jpg') }}" class="rounded-circle" alt="..."></a>
                                </div>
                                <div class="media-body align-self-center ml-3">
                                    <div class="title">
                                        <span class="username">Lisa Garett</span> To do list
                                    </div>
                                    <div class="time">42 min ago</div>
                                </div>
                            </div>
                            <img src="{{ asset('church/img/background/01.jpg') }}" alt="..." class="img-fluid">
                ...
                <div class="widget widget-05 has-shadow">
                    ...
                    <div class="widget-body no-padding hidden">
                        <div class="author-avatar">
                            ...
                            <img src="{{ asset('church/img/avatar/avatar-03.jpg') }}" alt="..." class="img-fluid rounded-circle">
                        </div>
                                ...
                                <li class="list-group-item">
                                    <div class="media">
                                        ...
                                        <div class="media-body align-self-center">
                                            ...
                                            <div class="meta">
                                                <span class="mr-3 text-color-hbd">Happy Birthday <i class="ion-heart heart-hbd"></i></span>
                                            </div>
                                        </div>
                                    </div>
                                </li>
                        ...
                        <div class="table-responsive table-scroll padding-right-10" style="max-height:520px;">
                            <table class="table table-hover mb-0">
                                ...
                                <tr>
                                    ...
                                    <td><span class="text-primary">Khandaker</span></td>
                                    <td>Akash</td>
                                    <td>US</td>
                                    <td>10/21/2017</td>
                                    <td><span style="width:100%;"><span class="badge-text badge-text-small info">Visitor</span></span></td>
                                    <td class="td-actions">
                                ...
                                <tr>
                                    ...
                                    <td><span class="text-primary">Mkh</span></td>
                                    <td>Sojib</td>
                                    <td>BD</td>
                                    <td>10/21/2017</td>
                                    <td><span style="width:100%;"><span class="badge-text badge-text-small success">Church member</span></span></td>
                                    <td class="td-actions">
                                        <a href="#"><i class="la la-edit edit"></i></a>
                                        <a href="#"><i class="la la-close delete"></i></a>
                                    </td>
                                ...
                                <tr>
                                    ...
                                    <td><span class="text-primary">Tapos</span></td>
                                    <td>Ghosh</td>
                                    <td>AU</td>
                                    <td>08/21/2017</td>
                                    <td><span style="width:100%;"><span class="badge-text badge-text-small danger">Prospective member</span></span></td>
                                    <td class="td-actions">
                                        <a href="#"><i class="la la-edit edit"></i></a>
                                        <a href="#"><i class="la la-close delete"></i></a>
                                    </td>
                    ...
                    <div class="widget-body no-padding">
                        <ul class="ticket list-group w-100">
                            ...
                            <li class="list-group-item">
                                <div class="media">
                                    <div class="media-left align-self-center pr-4">
                                        <img src="{{ asset('church/img/avatar/avatar-05.jpg') }}" class="user-img rounded-circle" alt="...">
                                    </div>
                                    <div class="media-body align-self-center">
                                        <div class="username">
                                            <h4>Megan Duncan</h4>
                ...
                <div class="widget widget-11 has-shadow">
                    ...
                    <div class="widget-body p-0 widget-scroll" style="max-height:450px;">
                        ...
                        <div class="timeline violet">
                            <div class="timeline-content d-flex align-items-center">
                                <div class="user-image">
                                    <img class="rounded-circle" src="{{ asset('church/img/avatar/avatar-06.jpg') }}" alt="...">
                                </div>
                        ...
                        <div class="timeline violet">
                            <div class="timeline-content d-flex align-items-center">
                                <div class="user-image">
                                    <img class="rounded-circle" src="{{ asset('church/img/avatar/avatar-05.jpg') }}" alt="...">
                                </div>
                                <div class="d-flex flex-column mr-auto">
                                    <div class="title">
                                        ...
                                        <div class="users-like">
                                            <a href="profile.html">
                                                <img src="{{ asset('church/img/avatar/avatar-01.jpg') }}" class="img-fluid rounded-circle" alt="...">
                                            </a>
                                            <a href="profile.html">
                                            ...
                                            <a href="profile.html">
                                                <img src="{{ asset('church/img/avatar/avatar-09.jpg') }}" class="img-fluid rounded-circle" alt="...">
                                            </a>
                                        </div>
                                    </div>
                                ...
                                <div class="d-flex flex-column mr-auto">
                                    <div class="title">
                                        ...
                                        <div class="users-like">
                                            ...
                                            <a href="profile.html">
                                                <img src="{{ asset('church/img/avatar/avatar-03.jpg') }}" class="img-fluid rounded-circle" alt="...">
                                            </a>
                                        </div>
                                    </div>
                        ...
                        <div class="timeline violet">
                            <div class="timeline-content d-flex align-items-center">
                                <div class="user-image">
                                    <img class="rounded-circle" src="{{ asset('church/img/avatar/avatar-04.jpg') }}" alt="...">
                                </div>
                                <div class="d-flex flex-column mr-auto">
                                    <div class="title">
                        ...
                        <div class="timeline violet">
                            <div class="timeline-content d-flex align-items-center">
                                <div class="user-image">
                                    <img class="rounded-circle" src="{{ asset('church/img/avatar/avatar-03.jpg') }}" alt="...">
                                </div>
                                <div class="d-flex flex-column mr-auto">
                                    <div class="title">
                        ...
                        <div class="new-message">
                            <div class="media">
                                <div class="media-left align-self-center mr-3">
                                    <img src="{{ asset('church/img/avatar/avatar-04.jpg') }}" alt="..." class="img-fluid rounded-circle" style="width: 50px;">
                                </div>
                                <div class="media-body align-self-center">
                        ...
                        <ul class="list-group w-100 mt-5">
                            <li class="list-group-item">
                                <div class="other-message">
                                    <div class="media">
                                        <div class="media-left align-self-center mr-3">
                                            <img src="{{ asset('church/img/avatar/avatar-02.jpg') }}" alt="..." class="img-fluid rounded-circle" style="width: 50px;">
                                        </div>
                                        <div class="media-body align-self-center">
                            ...
                            <li class="list-group-item">
                                <div class="other-message">
                                    <div class="media">
                                        <div class="media-left align-self-center mr-3">
                                            <img src="{{ asset('church/img/avatar/avatar-03.jpg') }}" alt="..." class="img-fluid rounded-circle" style="width: 50px;">
                                        </div>
                                        <div class="media-body align-self-center">
                            ...
                            <li class="list-group-item">
                                <div class="other-message">
                                    <div class="media">
                                        <div class="media-left align-self-center mr-3">
                                            <img src="{{ asset('church/img/avatar/avatar-05.jpg') }}" alt="..." class="img-fluid rounded-circle" style="width: 50px;">
                                        </div>
                                        <div class="media-body align-self-center">
                    ...
                    <div class="widget-body p-0">
                        ...
                        <ul class="list-group w-100 widget-scroll" style="max-height:250px;">
                            <li class="list-group-item">
                                <div class="media">
                                    <div class="media-left align-self-center mr-3">
                                        <img src="{{ asset('church/img/avatar/avatar-02.jpg') }}" alt="..." class="img-fluid rounded-circle" style="width: 35px;">
                                    </div>
                                    <div class="media-body align-self-center">
                            ...
                            <li class="list-group-item">
                                <div class="media">
                                    <div class="media-left align-self-center mr-3">
                                        <img src="{{ asset('church/img/avatar/avatar-03.jpg') }}" alt="..." class="img-fluid rounded-circle" style="width: 35px;">
                                    </div>
                                    <div class="media-body align-self-center">
                            ...
                            <li class="list-group-item">
                                <div class="media">
                                    <div class="media-left align-self-center mr-3">
                                        <img src="{{ asset('church/img/avatar/avatar-04.jpg') }}" alt="..." class="img-fluid rounded-circle" style="width: 35px;">
                                    </div>
                                    <div class="media-body align-self-center">
                            ...
                            <li class="list-group-item">
                                <div class="media">
                                    <div class="media-left align-self-center mr-3">
                                        <img src="{{ asset('church/img/avatar/avatar-05.jpg') }}" alt="..." class="img-fluid rounded-circle" style="width: 35px;">
                                    </div>
                                    <div class="media-body align-self-center">
                            ...
                            <li class="list-group-item">
                                <div class="media">
                                    <div class="media-left align-self-center mr-3">
                                        <img src="{{ asset('church/img/avatar/avatar-06.jpg') }}" alt="..." class="img-fluid rounded-circle" style="width: 35px;">
                                    </div>
                                    <div class="media-body align-self-center">
                            ...
                            <li class="list-group-item">
                                <div class="media">
                                    <div class="media-left align-self-center mr-3">
                                        <img src="{{ asset('church/img/avatar/avatar-07.jpg') }}" alt="..." class="img-fluid rounded-circle" style="width: 35px;">
                                    </div>
                                    <div class="media-body align-self-center">
                            ...
                            <li class="list-group-item">
                                <div class="media">
                                    <div class="media-left align-self-center mr-3">
                                        <img src="{{ asset('church/img/avatar/avatar-08.jpg') }}" alt="..." class="img-fluid rounded-circle" style="width: 35px;">
                                    </div>
                                    <div class="media-body align-self-center">
                            ...
                            <li class="list-group-item">
                                <div class="media">
                                    <div class="media-left align-self-center mr-3">
                                        <img src="{{ asset('church/img/avatar/avatar-09.jpg') }}" alt="..." class="img-fluid rounded-circle" style="width: 35px;">
                                    </div>
                                    <div class="media-body align-self-center">
                                ...
                                <div class="widget20 owl-carousel">
                                    <div class="item">
                                        <div class="card-image">
                                            <img src="{{ asset('church/img/background/03.jpg') }}" alt="...">
                                    ...
                                    <div class="item">
                                        <div class="card-image">
                                            <img src="{{ asset('church/img/background/04.jpg') }}" alt="...">
                                    ...
                                    <div class="item">
                                        <div class="card-image">
                                            <img src="{{ asset('church/img/background/05.jpg') }}" alt="...">
                                            <div class="card-overlay card-overlay-01">
                                                <div class="card-overlay-content">
                                                    <div class="category">
                                                        <a href="#">Category</a>
                                    ...
                                    <div class="item">
                                        <div class="card-image">
                                            <img src="{{ asset('church/img/background/02.jpg') }}" alt="...">
                                            <div class="card-overlay card-overlay-02">
                                                <div class="card-overlay-content">
                                                    <div class="category">
                                                        <a href="#">Category</a>
